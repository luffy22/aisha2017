...
<div class="float-xs-right"><span class="glyphicon glyphicon-user"></span> Profile  |  <a href="<?php echo JURI::base() ?>details" title="Edit Details"><span class="glyphicon glyphicon-pencil"></span> Details</a> | <a href="<?php echo JURI::base() ?>finance" title="Edit Payment"><span class="glyphicon glyphicon-usd"></span> Payment Details</a></div>
<div id="paid_dash">
<h3>Basic Details</h3>       
<div>
          <div class="row">
